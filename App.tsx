...
const AboutSection: React.FC = () => (
  <div className="grid md:grid-cols-2 gap-12 items-center">
    ...
    <div>
      <h2 className="text-5xl font-handwriting mb-6 text-gryffindor">
        {USER_INFO.name}
      </h2>
      <h3 className="text-2xl font-serif mb-6 border-b-2 border-ink pb-2 inline-block">
        {USER_INFO.role}
      </h3>
...
const ExperienceSection: React.FC = () => (
  <div>
    <h2 className="text-4xl font-handwriting mb-10 text-center text-ink">
      ...
      {EXPERIENCES.map((exp, index) => (
        <div key={index} className="relative pl-8 md:pl-12">
          ...
          <div className="bg-parchment/50 p-6 rounded border border-ink/20 shadow hover:shadow-lg transition-all hover:bg-parchment transform hover:-translate-x-1">
            <span className="text-sm font-bold tracking-widest text-gryffindor uppercase mb-2 block">
              {exp.period}
            </span>
            <h3 className="text-2xl font-bold text-ink">{exp.role}</h3>
            <h4 className="text-xl font-handwriting text-ink/80 mb-4">
              {exp.company}
            </h4>
  ...
  <div>
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
      {CERTIFICATES.map((cert, index) => (
        <div
          key={index}
          className="bg-parchment border border-ink p-4 text-center rounded shadow-md hover:shadow-xl transition-all group"
        >
          ...
          <h4 className="font-bold text-sm md:text-base leading-tight mb-2">
            {cert.name}
          </h4>
    ...
    <div className="grid md:grid-cols-2 gap-8">
      {PROJECTS.map((project, index) => (
        ...
        >
          <div className="relative overflow-hidden border border-ink mb-3 h-48">
            ...
            <div className="absolute inset-0 bg-parchment/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center p-4 z-20">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="bg-ink text-parchment px-6 py-2 rounded-full font-bold hover:bg-gryffindor transition-colors flex items-center space-x-2"
              >
                <GithubIcon size={20} />
          ...
          <h3 className="text-2xl font-bold text-center border-b border-ink/10 pb-2 mb-2">
            {project.title}
          </h3>
          <p className="text-center font-handwriting text-lg text-ink-light">
            {project.description}
          </p>
        </div>
      ))}
...
const ContactSection: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h2 className="text-4xl font-handwriting mb-12 text-center text-ink">
        Envie uma Coruja
      </h2>
          ...
          <div className="space-y-4 mt-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a
                ...
                className="hover:text-gryffindor transition-colors"
              >
                {USER_INFO.email}
              </a>
            </div>
            ...
            <div className="relative inline-block text-left">
              ...
              {showDownloadOptions && (
                <div className="origin-top-right absolute left-0 mt-2 w-56 rounded-md shadow-lg bg-parchment ring-1 ring-black ring-opacity-5">
        ...
        >
          <div>
            ...
            <input
              ...
              name="name"
              required
              className="w-full bg-transparent border-b-2 border-ink p-2 focus:outline-none focus:border-gryffindor transition-colors font-handwriting text-xl"
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              required
              className="w-full bg-transparent border-b-2 border-ink p-2 focus:outline-none focus:border-gryffindor transition-colors font-handwriting text-xl resize-none"
          ...
          <button
            type="submit"
            className="w-full bg-ink text-parchment font-bold py-3 px-6 rounded uppercase tracking-widest hover:bg-gryffindor transition-colors shadow-lg mt-4 flex justify-center items-center space-x-2"
          >
